package net.mcreator.betterores;
...
@Mod("betterore")
public class BetteroreMod {
	public static final Logger LOGGER = LogManager.getLogger(BetteroreMod.class);
	public static final String MODID = "betterore";
	...
	public BetteroreMod() {
		...
		BetteroreModBlocks.REGISTRY.register(bus);
